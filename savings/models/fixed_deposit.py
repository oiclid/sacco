...
class FixedDeposit(models.Model):
    user = models.ForeignKey(
        ...
        related_name="fixed_deposit_accounts"
    )
    balance = models.DecimalField(max_digits=20, decimal_places=2, default=0)
    interest_rate = models.DecimalField(max_digits=5, decimal_places=2, default=8.0)  # monthly %
    ...
    def __str__(self):
        return f"FixedDeposit #{self.pk} ({self.user.username})"
